...
public class Pagamento implements Serializable{
	...
	@Id
	//@GeneratedValue(strategy = GenerationType.IDENTITY) //GenerationType.IDENTITY -> n�o e necesserio usar pois o id vai vir da classe Pedido
	private Integer id;
	
	/*
	 * Esse lado e o dono do relacionamenrto.
	 * Existe um relacionamento bi direcional com a classe Pedido, embora n�o seja necessario.
	 * � comum em relacionamentos OneToOne que as tebelas sejam relacionadas com a mesma chave primaria
	 */
	@NotNull
	@OneToOne
	@MapsId // Pega o Id do outro lado da rela��o na classe Pedido e utiliza no id aqui da classe private Integer id - UTILIZA��O DA MESMA CHAVE PRIMARIA NAS 2 CLASSES
	 ...
	 */
	@Enumerated(EnumType.STRING) // Pega o texto no enum, pode ser pegar o numero tamb�m
	 ...
	 * 
	 * REGRAS : Pega os 4 ultimos digitos do cart�o
	 * @param numCartao
	 */
	public void definirNumeroEBandeira(String numCartao) {
		
		// Pega o numero do cart�o da posi��o 12 em diante, como o cartao tem 16 digitos ele vai pegar os 4 ultimos
