...
public class SearchFilter {
	 ...
	 * A ação do usuario que vai decidir qual e o tipo de informa��o, se a procura for pela caixa de texto o tipo sera texto, se a procura for clicando em categorias o searchType tem que ser igual a categoria
	 * @author wepbi
	 *
	 */
	...
	// A taxa e criada na gera��o do objeto
	...
	/**
	 * Metodo que processa a informa��o do tipo de busca, texto ou categoria
	 */
	public void processFilter(String cmdString) {
		
		if(!StringUtils.isEmpty(cmdString)) { // Se o cmdString n�o for vazio
			...
			if(cmd == Command.EntregaGratis) {
				...
				/**
				 * Se a entrega gratis estava marcada, a entrega gratis foi clicada ent�o ela precisa ser desmarcada( se era true passa a ser false ) assim muda o estado no objeto, quando a pagina e direcionada no binding e verificado que � falso e desmarca o bot�o
				 * RESUMO : EM UMA NOVA REQUISI��O DA P�GINA O BOT�O ESTARA DESMARCADO, MOSTRANDO SEU ESTADO REAL
				 */
